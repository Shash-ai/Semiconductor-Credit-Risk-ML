# AUTO-GENERATED COMMUNITY CLOUD VERSION
# Local dashboard remains unchanged.
...
DEFAULT_ROOT = Path('/Users/shashankyadav/Library/CloudStorage/OneDrive-WOXSENUNIVERSITY/Semiconductor_Credit_Risk_ML')
